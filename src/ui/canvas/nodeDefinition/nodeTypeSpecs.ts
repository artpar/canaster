...
export const nodeTypeSpecs = {
  ...
  heading: {
    type: BuiltInNodeTypes.heading,
    displayName: 'Heading',
    roleDescription: 'Heading',
    typeBadge: 'HEADING',
    addMenu: {
      label: 'Heading',
      detail: 'Label a section of the workspace',
      badge: 'HEAD',
    },
    defaultSize: { w: 340, h: 112 },
    minSize: { w: 180, h: 72 },
  },
  status: {
    type: BuiltInNodeTypes.status,
    displayName: 'Status',
    roleDescription: 'Status',
    typeBadge: 'STATUS',
    addMenu: {
      label: 'Status',
      detail: 'Progress, owner, and due date',
      badge: 'STATUS',
    },
    defaultSize: { w: 260, h: 132 },
    minSize: { w: 160, h: 84 },
  },
  contact: {
    type: BuiltInNodeTypes.contact,
    displayName: 'Contact',
    roleDescription: 'Contact',
    typeBadge: 'CONTACT',
    addMenu: {
      label: 'Contact',
      detail: 'Person, role, and contact details',
      badge: 'CONTACT',
    },
    defaultSize: { w: 280, h: 156 },
    minSize: { w: 180, h: 96 },
  },
  date: {
    type: BuiltInNodeTypes.date,
    displayName: 'Date',
    roleDescription: 'Date',
    typeBadge: 'DATE',
    addMenu: {
      label: 'Date',
      detail: 'Important date or appointment',
      badge: 'DATE',
    },
