...
export function createAgentAccessBrief(input: AgentAccessBriefInput): string {
  ...
  return [
    ...
    '- Preview responses may be hundreds of KB or more. Use websocket tooling that preserves complete messages, such as websocat -B 8000000.',
    ...
    `- preview.capture: {"canasterAgentProtocol":"v1","kind":"request","requestId":"<id>","documentId":"${input.documentId}","resource":"preview","action":"capture","params":{"maxBytes":5000000}}`,
