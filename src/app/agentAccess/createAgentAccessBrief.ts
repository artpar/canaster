...
export function createAgentAccessBrief(input: AgentAccessBriefInput): string {
  ...
  return [
    ...
    '- Read the workspace title, active view, canvases, sync state, current stateVersion, active canvas work items, and important child views.',
    ...
    '- Suggest semantic next actions based on the workspace content, such as clarify a work item, add missing operational detail, reorganize a view, capture proof, save changes, or open a relevant child view.',
