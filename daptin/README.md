...
- Daptin `v0.12.27` schema sync writes the action permission from `schema_canaster_share.yaml`; the smoke test verifies the imported `get_canaster_document_by_public_path` action remains `2085152`.
