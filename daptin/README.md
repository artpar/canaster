...
See `docs/daptin/canaster-mail-repair-journey.md` for the July 2026 mail repair notes, including the evidence boundaries, false-success trap around action responses, local MX/DNS requirement, and the reason future mail work must rely on Daptin subject object access instead of duplicate ownership conditions in action JavaScript.
