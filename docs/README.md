...
- `daptin/canaster-mail-repair-journey.md` - Canaster-specific July 2026 mail repair journey, evidence boundaries, false-success traps, DNS requirement, and final send/receive shape.
